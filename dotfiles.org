...
#+begin_src lua :tangle :tangle (when (eq system-type 'darwin) "~/.hammerspoon/modules/dashboard.lua")
    ...
    function generate_result()
       local git_status = {
          org = { 'cd ~/Documents/org && git status  --porcelain', "col-sm", 5 },
          roam = { "cd ~/Documents/roam && git status  --porcelain", "col-sm", 12 },
          dotfiles = { "cd ~/.emacs.d/ && git status  --porcelain", "col-sm", 7 }
       }

       local todos = {
          todolist = {'cat ~/Documents/org/todo.org  | grep "* TODO" | sed "s/TODO/""/g"'}
       }

       local result = generate_html_row_div(git_status)
       result = result .. generate_html_row_div(todos)
       return result
    end
    ...
    function generate_html_row_div(tb)
       ...
       for k, v in pairs(tb) do
          result = result .. '<div class="col-sm" style="text-align: center">'
