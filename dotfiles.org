...
#+begin_src lua :tangle (when (eq system-type 'darwin) "~/.hammerspoon/init.lua") :mkdirp "yes"
  hs.loadSpoon("AClock")
  hs.loadSpoon("WinWin")
...
#+end_src
** Dashboard
#+begin_src lua :tangle (when (eq system-type 'darwin) "~/.hammerspoon/modules/dashboard.lua")
