...
#+begin_src lua :tangle :tangle (when (eq system-type 'darwin) "~/.hammerspoon/modules/dashboard.lua")
  ...
  function generate_result()
     local row_git_status = {
        org = { 'cd ~/Documents/org && git status  --porcelain', "four columns", 5 },
        roam = { "cd ~/Documents/roam && git status  --porcelain", "four columns", 12 },
        dotfiles = { "cd ~/.emacs.d/ && git status  --porcelain", "four columns", 7 }
     }

     local result = generate_html_row_div(row_git_status)
     return result
  end
  ...
  function generate_html_row_div(tb)
     ...
     for k, v in pairs(tb) do
        result = result .. '<div style="height: 300px" class="' .. v[2] .. '">'
  ...
  function html_dashboard(content)
     local html = [[
      ...
      <html>
        ...
        <body>
          <h1>Dashboard</h1>
          <div class="container example-grid docs-example">
            ]] .. content .. [[
          </div>
        </body>
      </html>
