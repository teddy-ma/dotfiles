...
#+begin_src emacs-lisp
  ...
  (defun hikarian-get-current-resource ()
    ...
    (let ((current_file_path (file-relative-name (buffer-file-name) (hikarian-get-project-root))))
      ...
      (cond
       ((string-match-p "controller" current_file_path) (message "this is controller"))
       ((string-match-p "model"  current_file_path) (message "this is model"))
       ((string-match-p "view"  current_file_path) (message "this is view"))
