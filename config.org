...
*** Tabs and indent
TODO check every attribute and move indent-guide to Hightlight Indent guides
#+begin_src emacs-lisp
  ...
  TODO link to uniqufiy package?
    (setq uniquify-buffer-name-style 'forward)

TODO I use fish, should I delete it?
