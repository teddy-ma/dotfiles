...
<div style="margin: 1em auto; position: fixed; left: 10px; top: 10px">
  <button onclick="swapStyle('mini.css')">mini</button>
  <button onclick="swapStyle('bootstrap.css')">Bootstrap</button>
  <button onclick="swapStyle('org.css')">Org</button>
</div>
#+END_EXPORT
