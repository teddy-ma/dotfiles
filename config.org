...
** Welcome dashboard
#+begin_src emacs-lisp
  (setq emacs-banner "~/ownCloud/Photos/emacs-banner.png")
...
#+begin_src emacs-lisp
  (setq-default custom-enabled-themes '(kaolin-light color-theme-sanityinc-tomorrow-day))
  ...
  (defun theme-night ()
    "Active color-theme-sanityinc-tomorrow-night theme."
    (interactive)
    (color-theme-sanityinc-tomorrow-night))

  (defun theme-blue ()
    "Active color-theme-sanityinc-tomorrow-blue theme."
    (interactive)
    (color-theme-sanityinc-tomorrow-blue))

  (defun theme-bright ()
    "Active color-theme-sanityinc-tomorrow-bright theme."
    (interactive)
    (color-theme-sanityinc-tomorrow-bright))

  (defun theme-eighties ()
    "Active color-theme-sanityinc-tomorrow-eighties theme."
    (interactive)
    (color-theme-sanityinc-tomorrow-eighties))
#+end_src

custom hl-line and mode-line bg color
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (defun teddy-ma/org-block-setup ()
    (let ((background-color (face-attribute 'default :background)))
      (set-face-attribute 'org-block-begin-line nil :foreground background-color :background nil)
      (set-face-attribute 'org-block-end-line nil :foreground background-color :background nil)
      (set-face-attribute 'org-block nil :background background-color)))
