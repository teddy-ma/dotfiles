...
#+end_src
** Snippet
Snippet is very importent since it can save many time when programming.
Here are some help function when using snippet template
#+begin_src emacs-lisp
  ;;;TODO class name with namespace
  ;;;TODO initilaize method with params assigned

  (defun teddy-ma/get-name-with-namespace-and-without-extension ()
