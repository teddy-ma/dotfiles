...
#+begin_src emacs-lisp
  ...
  (setq mode-line-align-left ;; buufer name
        '(
          ""
          "%2 "
          "%2 "
  ...
  (defun teddy-ma/refresh-mode-line ()
    ...
    (if (eql (member `mode-line-modes mode-line-align-left) nil)
        (setq mode-line-align-left (nbutlast mode-line-align-left 1))
      (setq mode-line-align-left (append mode-line-align-left `(mode-line-modes))))
