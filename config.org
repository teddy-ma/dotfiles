...
* Bootstrap
** About this config
   I found this post is awesome https://utf9k.net/blog/faq-driven-configuration/
   So I try to use the faq style to make this config file.
   Maybe BDD's Given-When-Then is style is awesome too.
...
#+end_src
** How to install emacs packages effectively?
...
** How to have a single custom settings config file?
...
** Automatically inserting matching pairs of delimiters
#+begin_src emacs-lisp
...
#+end_src
** I use org to do GTD
*** I want to have custom todo sequence
#+begin_src emacs-lisp
  ...
  (use-package org-capture
    ...
    (add-to-list 'org-capture-templates
                 '("w" "Work" entry
                   ...
                   "* %?" :empty-lines 0)))
#+end_src
** I can easily open common files                                  :@script:
#+begin_src emacs-lisp
...
* Extras
** check my writing sytle and spell                             :@dependent:
...
** I need Chinese input method                            :@dependent:
#+begin_src emacs-lisp
  (use-package pyim
    :ensure t
    :demand t
